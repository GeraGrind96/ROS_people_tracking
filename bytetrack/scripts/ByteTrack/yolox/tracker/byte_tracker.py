...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, clase, orientation):
        ...
        # self.orientation_memory = deque(maxlen=5)
        # self.last_orientation_stored = time.time()
        # self.store_orientation_period = 0.01
        self.orientation = orientation
        # self.orientation_memory.append(round(self.orientation, 3))
...
class BYTETracker(object):
    def __init__(self, frame_rate=30, buffer_=90):
